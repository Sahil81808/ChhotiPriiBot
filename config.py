...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/Sahil81808/ChhotiPriiBot.git")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/NebulixNetwork")
...
if SUPPORT_CHANNEL:
    if not re.match(r"(?:http|https://t.me/NebulixNetwork)://", SUPPORT_CHANNEL):
        raise SystemExit(
            "[ERROR] - SUPPORT_CHANNEL URL is invalid. It must start with https://t.me/NebulixNetwork://"
        )

if SUPPORT_GROUP:
    if not re.match(r"(?:https|https://t.me/NebulixNetwork)://", SUPPORT_GROUP):
        raise SystemExit(
            "[ERROR] - SUPPORT_GROUP URL is invalid. It must start with https://t.me/NebulixNetwork"
        )
